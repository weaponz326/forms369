...
@Component({
  selector: 'app-exec-view-company-admins-page',
  templateUrl: './exec-view-company-admins-page.component.html',
  styleUrls: ['./exec-view-company-admins-page.component.css']
})
export class ExecViewCompanyAdminsPageComponent implements OnInit {
  userType: number;
  branchId: number;
  canEdit: boolean;
  canDelete: boolean;
