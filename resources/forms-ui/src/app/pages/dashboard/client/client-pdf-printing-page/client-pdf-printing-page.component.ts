...
@Component({
  ...
  templateUrl: './client-pdf-printing-page.component.html',
  styleUrls: ['./client-pdf-printing-page.component.css']
})
export class ClientPdfPrintingPageComponent implements OnInit {
  form: any;
  user: Users;
  pdfSrc: string;
  dpiRatio: any;
