...
@Component({
  ...
  templateUrl: './client-pdfdownloading-page.component.html',
  styleUrls: ['./client-pdfdownloading-page.component.css']
})
export class ClientPDFDownloadingPageComponent implements OnInit, AfterViewInit {
