...
@Component({
  selector: 'app-admin-view-company-executives-page',
  templateUrl: './admin-view-company-executives-page.component.html',
  styleUrls: ['./admin-view-company-executives-page.component.css']
})
