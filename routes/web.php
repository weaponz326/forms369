...
Route::get('git_admin/create/sector', function () {
  View::addExtension('html', 'php');
  return View::make('index');
});
...
Route::get('git_admin/edit/sector', function () {
  View::addExtension('html', 'php');
  return View::make('index');
});
...
Route::get('git_admin/lists/abuse_report', function () {
  View::addExtension('html', 'php');
  return View::make('index');
});

Route::get('git_admin/lists/sector', function () {
  View::addExtension('html', 'php');
  return View::make('index');
});
